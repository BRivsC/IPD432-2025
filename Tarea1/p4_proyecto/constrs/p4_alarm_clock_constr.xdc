...
##Switches
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { SW0 }]; #IO_L24N_T3_RS0_15 Sch=SW0
set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS33 } [get_ports { SW1 }]; #IO_L3N_T0_DQS_EMCCLK_14 Sch=SW1
...
set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33 } [get_ports { LEDS_ALARMA[0] }]; #IO_L14N_T2_SRCC_14 Sch=leds_alarma[0]
set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33 } [get_ports { LEDS_ALARMA[1] }];# IO_L22P_T3_A05_D21_14 Sch=leds_alarma[1]
set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { LEDS_ALARMA[2] }];# IO_L15N_T2_DQS_DOUT_CSO_B_14 Sch=leds_alarma[2]
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33 } [get_ports { LEDS_ALARMA[3] }];# IO_L16P_T2_CSI_B_14 Sch=leds_alarma[3]
set_property -dict { PACKAGE_PIN V14   IOSTANDARD LVCMOS33 } [get_ports { LEDS_ALARMA[4] }];# IO_L22N_T3_A04_D20_14 Sch=leds_alarma[4]
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { LEDS_ALARMA[5] }];# IO_L20N_T3_A07_D23_14 Sch=leds_alarma[5]
set_property -dict { PACKAGE_PIN V11   IOSTANDARD LVCMOS33 } [get_ports { LEDS_ALARMA[6] }];# IO_L21N_T3_DQS_A06_D22_14 Sch=leds_alarma[6]
