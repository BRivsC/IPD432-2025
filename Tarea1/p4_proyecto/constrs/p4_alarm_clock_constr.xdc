...
##Switches
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { SWITCH }]; #IO_L24N_T3_RS0_15 Sch=SWITCH
...
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { FUN_SWITCH }];# IO_L21P_T3_DQS_14 Sch=FUN_SWITCH
## LEDs#
